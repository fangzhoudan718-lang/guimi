    ...
    public class UnshadowedCross : LotMItem
    {
        ...
        public override bool? UseItem(Player player)
        {
            if (player.whoAmI == Main.myPlayer)
            {
                ...
                DowngradePathway(ref modPlayer.baseDoorSequence, ref modPlayer.currentDoorSequence, "门");
                DowngradePathway(ref modPlayer.baseBlackEmperorSequence, ref modPlayer.currentBlackEmperorSequence, "黑皇帝");
