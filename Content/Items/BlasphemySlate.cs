...
namespace zhashi.Content.Items
{
    public class BlasphemySlate : ModItem
    {
        ...
        private static readonly List<(int level, string pathway, string name, string content, string ritual, Color color)> RecipeDatabase = new()
        {
            ...
            (9, "学徒/门途径", "序列9 学徒", "水瓶 + 木头(5) + 银币(5) + 指南针(1)", "直接服用魔药。", new Color(232, 200, 120)),
            (8, "学徒/门途径", "序列8 戏法大师", "水瓶 + 火把(10) + 玻璃(10) + 丝绸(5) + 瓶子(3)", "直接服用魔药 (序列9学徒晋升)。", new Color(232, 200, 120)),
            (7, "学徒/门途径", "序列7 占星人", "水瓶 + 坠落之星(3) + 蓝宝石(2) + 瓶子(3) + 魔镜(1)", "直接服用魔药 (序列8戏法大师晋升)。", new Color(232, 200, 120)),
            (6, "学徒/门途径", "序列6 记录官", "水瓶 + 光明/暗影之魂各(5) + 骨头(30) + 粉胶(10)", "直接服用魔药 (序列7占星人晋升)。", new Color(232, 200, 120)),
            (5, "学徒/门途径", "序列5 旅行家", "水瓶 + 魔镜(1) + 指南针(1) + 坠落之星(5) + 翼之魂(5) + 金币(5)", "直接服用魔药 (序列6记录官晋升)。", new Color(232, 200, 120)),
        };
